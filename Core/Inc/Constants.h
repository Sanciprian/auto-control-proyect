...
class Constants{
    ...
    public:
		...
		inline static constexpr Pin kFrontLeftEncoder = {GPIOA, GPIO_PIN_1};
		inline static constexpr Pin kFrontRightEncoder = {GPIOA, GPIO_PIN_0};
		inline static constexpr Pin kBackLeftEncoder = {GPIOA, GPIO_PIN_2};
		inline static constexpr Pin kBackRightEncoder = {GPIOA, GPIO_PIN_3};
